...
The best two predictors for a perch would be height and width. 
...
### Best Models
The best models is all variables.


### Best Two regressor model
The best two regressor models were length 1 and length 3. 
...
### Best Two regressor model
The best two regressor models are length 3 and width. 


## Final Summary Statements
With the data that was gathered, we are able to conclude that the best regressor models for Perch were height and width. Best regressor models for Pike were length 1 and length 3. Best regressor model for Roach were length 3 and width. 
